...
def generate_page(from_path, template_path, dest_path, basepath):
    ...
    full_site = full_site.replace('href="/', f'href="{basepath}')
    full_site = full_site.replace('src="/', f'src="{basepath}')
...
def generate_pages_recursive(dir_path_name, template_path, dest_dir_path, basepath):
    ...
    for item in path_content:
        ...
        if os.path.isfile(item_path):
            ...
            generate_page(item_path, template_path, path_with_html_suffix, basepath)
